        ...
        try {
            ...
            String htmlContent = String.format("""
                <html>
                    <body>
                        <h2>Olá</h2>
                        <p>Seu pedido foi efeteuado com sucesso e já estamos produzindo</p>
                        <br>
                        <p>Seu pedido de: %s será entregue em até 2 horas.</p>
                        <p>Atenciosamente,<br>
                        <p>Com carinho da Equipe Marimbondo Rei</p>
                    </body>
                </html>
                """, produto);
